import { ArgsMountain } from '../tipos';
...
import { loopNoise, normRand, poly, randChoice } from '../utilidades/Util';
import { arch01, arch02, arch03, arch04, transmissionTower01 } from './Arch';
import { tree01, tree02, tree03, tree04, tree05, tree06, tree07, tree08 } from './Tree';
...
export function mountain(xoff: number, yoff: number, seed: number = 0, args?: ArgsMountain) {
  ...
  const { hei, wid, tex, veg, ret, col } = { ...predeterminados, ...args };
...
export function flatMount(xoff, yoff, seed, args) {
  var args = args != undefined ? args : {};
...
export function distMount(xoff, yoff, seed, args) {
  var args = args != undefined ? args : {};
...
export function rock(xoff, yoff, seed, args) {
  var args = args != undefined ? args : {};
